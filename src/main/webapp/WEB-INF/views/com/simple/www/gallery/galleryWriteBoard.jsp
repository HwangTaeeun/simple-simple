...
<body>
 ...
 -->
	...
	<form method="POST" action="/www/gallery/galleryWrite.van"><!-- encType="multipart/form-data" -->
	<div class="w3-col m6 w3-center">
		<h2 class="w3-col w3-padding w3-blue w3-margin-bottom">사진등록하기</h2>
		<div class="w3-col">
			<div id="" class="w3-padding w3-center">
				<img src="/www/img/profile/noimage.png" alt="noimage" class="pic1"
					id="profImg">
			</div>
				...
				<div class="w3-row">
					...
					<div class="w3-col m10 w3-padding">
						<textarea class="w3-input w3-border" id="body" name="body"
							placeholder="글 내용 입력" cols="10" rows="2" style="resize: none"></textarea>
					</div>
				</div>
			<div class="w3-col w3-margin-top">
				<div class="w3-button w3-small w3-red w3-hover-amber w3-left"
					id="cancle">cancel</div>
				<input type="submit" class="w3-button w3-small w3-green w3-hover-lime w3-right"
					value="글등록"></div>
			</div>
		</div>
	</div>
	...
	<script type="text/javascript">
		$('#cancel').click(function() {
			$(location).attr('href', '/www/gallery/gallery.van');
		});
