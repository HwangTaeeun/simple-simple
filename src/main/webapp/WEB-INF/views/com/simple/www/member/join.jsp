...
<body>
	<div class="container">
		...
		<div class="listbox">								<!-- enctype은 바이트 단위로 파라미터를 전송함  -->
	<form method="POST" action="/www/member/joinProc.van" enctype="multipart/form-data">
		<ul class="ulcl w3-margin-bottom w3-padding">
			...
			<li><label for="email">E-mail</label><input type="text" id="mail" name="mail" ></li>
			<p class="pcl" id="email_check"></p>
			
			<li><label for="num">Phone Number</label><input type="text" id="tel" name="tel" placeholder="예] 010-1111-1111" >
			...
			<li>
				<div class="w3-col">
					...
					<div id="" class="w3-padding w3-center">
						<img src="/www/img/profile/noimage.png" alt="noimage" class="pic1" id="profImg">
					</div>
				</div>
			</li>
		</ul>
