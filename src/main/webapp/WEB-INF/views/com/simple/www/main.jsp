	...
	$(document).ready(function(){
		...
		*/
		...
		$('#boardList').click(function(){
			$(location).attr('href', '/board/boardList.van');
		});
		...
		$('#bang').click(function(){
			$(location).attr('href','/www/member/guestboard.van');
		});
...
<body>
	...
	<div class="w3-col m8 w3-center w3-margin-top">
		...
		<div class="w3-col">
			<c:if test="${empty SID}">
				<div class="w3-col m2 w3-red w3-button" id="login">로그윙</div>
			...
			<c:if test="${not empty SID}">
				...
				<div class="w3-col m2 w3-black w3-button w3-font-white" id="bang">방명록</div>
			</c:if>
		</div>
	</div>
	...
	<div class="w3-modal m3" id="detail">
		<div class="w3-modal-content w3-center w3-padding">
			<div class="w3-container w3-white w3-padding">
				...
				<h2 class="w3-col w3-purple w3-padding w3-card">회원 정보ㅎㅎ</h2>
